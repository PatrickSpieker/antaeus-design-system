(() => {
  ...
  function App() {
    ...
    React.useEffect(() => {
      localStorage.setItem("antaeus.tab", tab);
    }, [tab]);
    const Screen = {
      home: /* @__PURE__ */ React.createElement(TodayScreen, null),
      data: /* @__PURE__ */ React.createElement(RecordScreen, { onAdd: () => setSheet(true) }),
      care: /* @__PURE__ */ React.createElement(CareScreen, null),
      me: /* @__PURE__ */ React.createElement(YouScreen, null)
    }[tab];
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(IOSDevice, { width: 402, height: 874 }, /* @__PURE__ */ React.createElement("div", { className: "app-screen", "data-screen-label": `01 ${tab}` }, /* @__PURE__ */ React.createElement("div", { style: { flex: 1, overflow: "hidden", paddingTop: 54, position: "relative" } }, /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, paddingTop: 54, overflowY: "auto" } }, Screen)), /* @__PURE__ */ React.createElement(TabBar, { active: tab, onChange: setTab }), sheet && /* @__PURE__ */ React.createElement(AddMeasurementSheet, { onClose: () => setSheet(false), onSave: () => setSheet(false) }))), /* @__PURE__ */ React.createElement("div", { className: "caption" }, "Antaeus Health \xB7 Consumer App \xB7 Today / Record / Care / You"));
  }
