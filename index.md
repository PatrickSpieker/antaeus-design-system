...
Shared design guidance for web and iOS. Always the latest definitions.
...
- [Token contract](guidance/tokens.md): JSON types, aliases, units, web/iOS adaptation.
- [JSON tokens](tokens.json): authoritative design values.
- [CSS tokens](tokens.css): generated custom properties for web.

Fetch only the guidance relevant to the task. Resolve links relative to this URL. Font files and implementation examples are not included.
